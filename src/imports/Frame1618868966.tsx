    ...
    <div className="content-stretch flex flex-col items-start relative size-full">
      <div className="bg-white h-[94px] relative shrink-0 w-full">
        <div className="leading-[normal] not-italic overflow-clip relative rounded-[inherit] size-full text-[#666668] uppercase whitespace-nowrap">
          ...
          <p className="absolute font-['Lato:Bold',sans-serif] left-[24px] text-[12px] top-[17px]">Current Term — 2025/2026</p>
      ...
      <div className="bg-white h-[76px] relative shrink-0 w-full">
        <div className="overflow-clip relative rounded-[inherit] size-full">
          <p className="absolute capitalize font-['Lato:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[16px] text-black top-[calc(50%-10px)] w-[96px]">Math</p>
      ...
      <Wrapper>
        <p className="absolute capitalize font-['Lato:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[16px] text-black top-[calc(50%-10px)] w-[109px]">Science</p>
      ...
      <Wrapper>
        <p className="absolute capitalize font-['Lato:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[16px] text-black top-[calc(50%-9.75px)] w-[54px]">English</p>
      ...
      <Wrapper>
        <Text1 text="B+" />
        <p className="absolute capitalize font-['Lato:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[16px] text-black top-[calc(50%-9.75px)] w-[69px]">History</p>
      ...
      <Wrapper>
        ...
        <p className="absolute capitalize font-['Lato:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[16px] text-black top-[calc(50%-9.75px)] whitespace-nowrap">Computer Science</p>
      ...
      <div className="bg-white h-[76px] relative shrink-0 w-full">
        <div className="overflow-clip relative rounded-[inherit] size-full">
          <p className="absolute capitalize font-['Lato:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[16px] text-black top-[calc(50%-9.75px)] whitespace-nowrap">Physics</p>
